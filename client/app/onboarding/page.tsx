        ...
        <div className="flex justify-between mb-12 relative">
          ...
          {steps.map((s) => (
            <div key={s.id} className="relative z-10 flex flex-col items-center gap-3">
              <div className={`w-12 h-12 rounded-full border-2 border-black flex items-center justify-center font-black transition-all ${
          ...
          >
            <Card variant="white" shadowSize="lg" className="p-12">
              {step === 1 && (
                <div className="space-y-8">
                  <div className="space-y-2">
                    <Badge variant="yellow">STEP 01</Badge>
                    <h2 className="text-4xl font-black uppercase tracking-tighter">Enter Gemini API Key</h2>
                    <p className="font-bold text-black/50">We need this to power your brain operating system.</p>
                  </div>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase tracking-widest">Gemini API Key</label>
                      <Input 
                        type="password" 
                        placeholder="AIzaSy..." 
                        value={apiKey}
                    ...
                    <p className="text-xs font-bold text-black/40">
                      Don&apos;t have a key? <a href="https://aistudio.google.com/app/apikey" target="_blank" className="underline">Get one here</a>.
                    </p>
                  </div>
              ...
              {step === 2 && (
                <div className="space-y-8">
                  <div className="space-y-2">
                    <Badge variant="sage">STEP 02</Badge>
                    <h2 className="text-4xl font-black uppercase tracking-tighter">Connect Notion</h2>
                    <p className="font-bold text-black/50">Orin uses Notion as your long-term memory store.</p>
                  </div>
                  <div className="p-8 border-2 border-dashed border-black/20 rounded-xl flex flex-col items-center justify-center gap-6 bg-neutral-50">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-bold text-black/40">Authorize Orin to read/write to your workspace.</p>
                    </div>
                    <Button 
                      variant="secondary" 
                ...
                <div className="space-y-8 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-bold text-black/50 max-w-md mx-auto">
                      Your brain operating system is ready. Start a conversation to begin capturing your thoughts.
                    </p>
                  </div>
