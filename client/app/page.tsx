...
import { ArrowRight, Zap, Shield, Brain, Layers, Layout, Users, Star, Github, Twitter, CheckCircle2, Database } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#ffe17c] font-sans overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-8 min-h-screen flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 z-10 space-y-8">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] text-black uppercase">
            TURN NOTION <br />
            <span className="text-transparent" style={{ WebkitTextStroke: '2px black' }}>INTO A LIVING</span> <br />
            MEMORY.
          </h1>
          
          <p className="text-xl font-medium text-black/80 max-w-lg">
            Orin turns Notion into a living memory. Read, structure, and act on your knowledge across every workflow with Gemini.
          </p>
      ...
      <div className="bg-[#171e19] border-y-2 border-black py-6 overflow-hidden flex whitespace-nowrap">
        ...
        >
          {['RESEARCH REPOSITORY', 'SECOND BRAIN', 'CONTENT ENGINE', 'MEETING NOTES', 'KNOWLEDGE BASE', 'PROJECT TRACKING', 'BRAIN DUMP', 'SYSTEM DESIGN'].map((useCase) => (
            <span key={useCase} className="text-3xl font-extrabold text-[#b7c6c2]/50 tracking-tighter uppercase">
              {useCase}
            </span>
          ))}
          {/* Duplicate for seamless loop */}
          {['RESEARCH REPOSITORY', 'SECOND BRAIN', 'CONTENT ENGINE', 'MEETING NOTES', 'KNOWLEDGE BASE', 'PROJECT TRACKING', 'BRAIN DUMP', 'SYSTEM DESIGN'].map((useCase) => (
            <span key={useCase + '_2'} className="text-3xl font-extrabold text-[#b7c6c2]/50 tracking-tighter uppercase">
              {useCase}
            </span>
          ))}
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card variant="white" className="group hover:-translate-x-2 hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all cursor-default h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              ...
              >
                ...
                <h3 className="text-4xl font-black uppercase transition-all group-hover:tracking-widest" style={{ color: item.color }}>{item.title}</h3>
                <p className="text-white/50 font-bold text-lg group-hover:text-white transition-colors leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border-4 border-black shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] bg-black">
            ...
            <div className="bg-[#171e19] p-12 space-y-10 relative overflow-hidden group">
              ...
              <div className="pt-8 border-t border-white/10 mt-auto">
                <p className="text-[#b7c6c2] text-xs font-black uppercase tracking-[0.2em]">Context-Aware Intelligence</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl font-bold text-black/50">Built with the most modern stack for performance and reliability.</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              { name: 'Next.js 15', desc: 'Framework', icon: Layout },
              ...
              <Card key={i} variant="white" className="p-6 text-center group hover:bg-[#ffe17c] transition-all cursor-default">
      ...
      <footer className="bg-[#171e19] py-20 px-8 text-white border-t-2 border-black">
          ...
          {[
            ...
            <div key={i} className="space-y-6">
              ...
              <ul className="space-y-4">
                {col.links.map(link => (
                  <li key={link}><a href="#" className="font-bold text-white/60 hover:text-white transition-colors">{link}</a></li>
                ))}
              </ul>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/Invariants0/ORIN" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#272727] border border-white/10 flex items-center justify-center hover:bg-[#ffe17c] hover:text-black transition-all cursor-pointer">
