...
import { AgentType, AgentStatus, MessagePriority } from '@/types/agent.types.js';

// Import agents
import { monitoringAgent } from '@/services/orchestration/agents/monitoring-agent.service.js';
import { optimizationAgent } from '@/services/orchestration/agents/optimization-agent.service.js';
import { recoveryAgent } from '@/services/orchestration/agents/recovery-agent.service.js';
import { planningAgent } from '@/services/orchestration/agents/planning-agent.service.js';
import { userAssistantAgent } from '@/services/orchestration/agents/user-assistant-agent.service.js';

// Import infrastructure
import messageBusService from '@/services/orchestration/agents/message-bus.service.js';
import sharedStateService from '@/services/orchestration/agents/shared-state.service.js';
import coordinatorService from '@/services/orchestration/agents/coordinator.service.js';
...
class MultiAgentOrchestratorService {
  ...
  private agents: Partial<Record<AgentType, any>> = {
